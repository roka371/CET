...
$(document).ready(function() {
	...
	$('.signup_modal2_choices_item_finish').click(function(){
		...
		/* Remove following and uncomment the commented section.
		...
		The email address, first name, last name, email, and password should refer to the temporary user currently stored in html as data variables
		ex. first name => $('#temp_user_firstname'); #temp_user_firstname should be stored in <div id="temp_user_firstname"></div>
		
		Upon creating the user, add a session cookie so that the user is "logged in."
		Also, add user variables to data divs, ex. user_id
		*/
		var user_id = $('#user_id').text();
